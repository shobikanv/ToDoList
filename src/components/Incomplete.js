...
function Incomplete({tasks,editTask,deleteTask,setEditTask,toggleComplete,updateTask}) {
    return ( 
        ...
        <li key={task.id} className="list-group-item d-flex justify-content-between align-items-center">
          {editTask === task.id ? (
              ...
              <Row>
                <Col>
                  <Form.Group controlId="updatedTitle">
                    <Form.Control type="text" placeholder="Enter updated task" defaultValue={task.task_title} /></Form.Group>
                </Col>
            ...
            <>
              {task.task_title}
              <div>
                <Button variant="success" type="button" onClick={() => toggleComplete(task.id)}>Complete</Button>
